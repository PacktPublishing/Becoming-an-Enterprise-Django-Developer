...
urlpatterns = [
    ...
    path('', TemplateView.as_view(template_name='chapter_8/index.html')),
    path('chapter-8/', include(router.urls)),
    path('api-auth/', include('rest_framework.urls')),
    #path('chapter-8/hello-world/', HelloWorldView.as_view(), name='hello-world'),
    path('chapter-8/get-seller/', GetSellerView.as_view(), name='get-seller'),
    path('chapter-8/seller/<int:id>/', GetSellerHTMLView.as_view(), name='seller-detail'),
    path('chapter-8/sellertoken/<int:id>/', GetSellerWithTokenView.as_view(), name='seller-token-detail'),
]
